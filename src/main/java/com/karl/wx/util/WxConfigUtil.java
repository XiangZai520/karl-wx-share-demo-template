...
import com.karl.wx.model.Token;
...
public class WxConfigUtil {
     ...
     * @return
     */
    public static Map<String, Object> getSignature(String appUrl, String url, String urlpath) {
        // 生成签名的随机串
        String noncestr = UUID.randomUUID().toString().replace("-", "");
        String signature = null;
        System.err.println(appId_ + "------" + appsecret_);
        Token accessTocken = getToken(appId_, appsecret_, System.currentTimeMillis() / 1000);
